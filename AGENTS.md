...
Beads (local). See `docs/agents/issue-tracker.md`.
...
| **docs/AGENTS.md** | `docs/` | Project documentation — PRD, issue tracker config, research |
...
- **Root AGENTS.md** owns: beads workflow, DOX framework rules, session close protocol, non-interactive shell conventions, user preferences
- **slices/AGENTS.md** owns: architecture structure, inter-slice contracts, naming conventions, session persistence rules
- **docs/AGENTS.md** owns: documentation standards, issue tracker configuration
- **shared/AGENTS.md** owns: type contract definitions, cross-slice interface governance
- **`.beads/`** is managed by `bd` (beads) tool — not covered by DOX
